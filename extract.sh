...
for test_dataset in "${test_dataset_list[@]}"; do
  python ./src/extract_features.py --benchmark mmlu --test_dataset $test_dataset --model_type decoder_only --model_name Llama-2-7b-chat-hf
done
...
for test_dataset in "${test_dataset_list[@]}"; do
  python ./src/extract_features.py --benchmark mrqa --test_dataset $test_dataset --model_type decoder_only --model_name Llama-2-7b-chat-hf
done
